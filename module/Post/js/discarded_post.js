...
function reloadData() {
	page = 0;
	var table = document.body.querySelector('.mui-row');
	$(table).empty();
	pullupRefresh();
}
...
var news = new Vue({
	...
	updated: function() {
		this.$nextTick(function() {
			$('.mui-row .mui-col-sm-6:nth-child(2n+1)').addClass('box-right');
			$('.mui-row .mui-col-sm-6:nth-child(2n)').addClass('box-left');
			$('.mui-row .mui-col-sm-6:nth-child(n+3)').addClass('box-top');
		})
	}
});
